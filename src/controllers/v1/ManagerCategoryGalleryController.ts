...
import {
  CategoryGalleryService,
  FileUploadService,
  Token,
} from "../../services";
const fileUploadService = new FileUploadService("category-gallery");

export default class ManagerCategoryGalleryController extends Controller {
  public version: string = "v1";
  public path: string = "/manager/category-gallery";
  ...
  async save(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const service = new CategoryGalleryService();
  ...
  async findAll(
    ...
    try {
      ...
      super.sendSuccess(res, data.data, "Category gallery images");
    } catch (err) {
      super.sendError(res, err.message);
    }
  }
    ...
    try {
      ...
      if (data.success) {
        ...
        super.sendSuccess(
          res,
          data.data,
          "Category gallery image deleted successfully"
        );
      } else {
  ...
  async updateOneById(
    ...
    try {
      ...
      super.sendSuccess(
        res,
        data.data,
        "Category gallery updated successfully"
      );
    } catch (err) {
      super.sendError(res, err.message);
    }
