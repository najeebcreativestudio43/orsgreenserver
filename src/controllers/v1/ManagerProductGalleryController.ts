...
const fileUploadService = new FileUploadService("product-gallery");

export default class ManagerProductGalleryController extends Controller {
  public version: string = "v1";
  public path: string = "/manager/product-gallery";
  ...
  async save(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const service = new ProductGalleryService();
  ...
  async findAll(
    ...
    try {
      ...
      super.sendSuccess(res, data.data, "Product gallery images");
    } catch (err: any) {
      super.sendError(res, err.message);
    }
  }
  ...
  async updateOneById(
    ...
    try {
      ...
      super.sendSuccess(res, data.data, "Product gallery updated successfully");
    } catch (err: any) {
      super.sendError(res, err.message);
    }
  }
