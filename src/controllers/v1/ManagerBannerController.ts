...
import { BannerService, FileUploadService, Token } from "../../services";
const fileUploadService = new FileUploadService("banners");

export default class ManagerBannerController extends Controller {
  public version: string = "v1";
  public path: string = "/manager/banners";
  ...
  async deleteOneById(
    ...
    try {
      ...
      if (data.success) {
        ...
        super.sendSuccess(res, data.data, "Banner deleted successfully");
      } else {
  ...
  async updateOneById(
    ...
    try {
      ...
      super.sendSuccess(res, data.data, "Banner updated successfully");
    } catch (err: any) {
      super.sendError(res, err.message);
    }
  }
