  ...
  public async createOrder(req: Request): Promise<IReturnData<Order>> {
    try {
      ...
      if (nearestStore) {
        ...
        console.log("nearest store found", nearestStore._id, req.body);
        req.body = await this.convertItemsIdToObjectIdsAndCalculateTotals(
          req.body
        );
        console.log("order body after conversion", req.body);
